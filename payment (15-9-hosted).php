                                    ...
                                    <form>
                                        ...
                                        <div class="mb-3 row" id="last_reg_ID_row" style="color: red;">
                                            <!--<label for="last_student_reg_id" class="col-sm-3 col-form-label fw-bolder">Last Student Reg ID:</label>-->
                                             <label for="last_student_reg_id" class="col-sm-3 col-form-label fw-bolder">Last Program Registration ID</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="mb-3 row align-items-center" id="currect_reg_id_row">
                                            ...
                                            <label for="specific_student_reg_id" class="col-sm-3 col-form-label">Program Registration ID</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="mb-3 row" id="Last_new_std_reg_id_row">
                                            ...
                                            <label for="Last_new_std_reg_ids" class="col-sm-3 col-form-label" style="color: red; font-weight: bolder;">Last BMS Registration ID</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="mb-3 row" id="already_have_new_id_row" style="display:none;">
                                            <!--<label class="col-sm-3 col-form-label" style="color: green; font-weight: bolder;">Already have New ID :</label>-->
                                             <label class="col-sm-3 col-form-label" style="color: green; font-weight: bolder;">BMS Registration ID</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" style="color: green; font-weight: bolder;" id="already_have_new_id_value" readonly>
                                            </div>
                                        </div>
                                            ...
                                            success: function(resp) {
                                                ...
                                                $.ajax({
                                                    ...
                                                    success: function(specificResp) {
                                                        console.log('DEBUG get_specific_student_reg_id response:', specificResp);
                                                        console.log('DEBUG sent params -> student_code:', student_id, 'program_code:', programme_code, 'batch_id:', batch_id);
                                                        var hasOldReg = specificResp.success && specificResp.student_registration_id;
                                                        var hasNewReg = specificResp.success && specificResp.new_student_registration_id;

                                                        // ---------------- BMS Registration ID (old / current) ----------------
                                                        if (hasOldReg) {
                                                            $('#specific_student_reg_id')
                                                                .val(specificResp.student_registration_id)
                                                                .prop('readonly', true);

                                                            $('#bms_automatic_ID, #program_code_row, #batch_no_row, #intake_no_row, #year_no_row, #last_reg_ID_row').hide();
                                                        } else {
                                                            $('#last_reg_ID_row').show();
                                                            $('#bms_automatic_ID, #program_code_row, #batch_no_row, #intake_no_row, #year_no_row')
                                                                .show()
                                                                .prop('readonly', true);
                                                        ...
                                                        // ---------------- BMS New Registration ID ----------------
                                                        // Independent of the old reg id above - if new_student_registration_id
                                                        // already exists (even when student_registration_id is empty/null),
                                                        // show "Already have New ID" instead of the generate-mode rows.
                                                        if (hasNewReg) {
                                                            $('#new_reg_id')
                                                                .val(specificResp.new_student_registration_id)
                                                                .prop('readonly', true);

                                                            $('#new_reg_id_row, #Last_new_std_reg_id_row').hide();
                                                            $('#already_have_new_id_value').val(specificResp.new_student_registration_id);
                                                            $('#already_have_new_id_row').show();
                                                        } else {
                                                            // No new ID yet - keep the auto-generated next ID
                                                            // (already computed earlier) visible and untouched.
                                                            $('#already_have_new_id_row').hide();
                                                            $('#Last_new_std_reg_id_row').show();
                                                            $('#new_reg_id_row').show();
                                                            $('#new_reg_id').prop('readonly', true);
                                                        }
                                                    },
                                                    error: function(xhr, status, error) {
