                                            ...
                                            <div class="card-body">
                                                ...
                                                SELECT s.*, 
                                                    ...
                                                    (SELECT status FROM assesment_document_send_email_log 
                                                     WHERE assessment_id = ? AND email = s.bms_email 
                                                     ORDER BY sent_date DESC LIMIT 1) as email_status,
                                                    (SELECT sent_date FROM assesment_document_send_email_log 
                                                     WHERE assessment_id = ? AND email = s.bms_email 
                                                     ORDER BY sent_date DESC LIMIT 1) as email_sent_date,
                                                    (SELECT sent_by FROM assesment_document_send_email_log 
                                                     WHERE assessment_id = ? AND email = s.bms_email 
                                                     ORDER BY sent_date DESC LIMIT 1) as sent_by,
                                                    (SELECT error_message FROM assesment_document_send_email_log 
                                                     WHERE assessment_id = ? AND email = s.bms_email 
                                                     ORDER BY sent_date DESC LIMIT 1) as error_message
                                                FROM students s 
