...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($allocateStmt = $conn->prepare($allocateQuery)) {
        ...
        if ($allocateStmt->execute()) {
            ...
            $query = "INSERT INTO program_reregister_table 
            ...
            if ($stmt = $conn->prepare($query)) {
                ...
                if ($stmt->execute()) {
                    ...
                    echo "<script>
                        alert('Student Program Re Register, Allocation & Payment Plan have been successfully recorded!');
                        window.location.href = window.location.href;
                    </script>";
                }
                $stmt->close();
        ...
        <div id="content">
            ...
            <div class="p-3">
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h4 class="h4 mb-0 text-gray-800">Program Re Register</h4>
                </div>

                <!-- Filter Form -->
                <form action="re_register.php" method="POST">
                    <div class="row mb-5">
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="student_id" id="select_student" class="form-control select2" required>
                                ...
                                $query = "
                                    ...
                                    WHERE a.status = 'ReRegister'  AND s.transfer_status = 0
                                    ";
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <label for="from_registration_code"><s>Current Registration Last
                                                        Code</s>
                                                </label>
                                            </div>
                                            <div class="col-md-8">
                                    ...
                                    <div class="form-group fw-bolder">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <label for="from_registration_code"> <s> Registration Code New For
                                                        Selected
                                                        Batch</s></label>
                                            </div>
                                            <div class="col-md-8">
