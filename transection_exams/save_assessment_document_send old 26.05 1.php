...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt->execute()) {
        ...
        header("Location: ../assesmentDocumentSend?success=1");
        exit();
    } else {
        // Redirect back to the exams page with an error message
        header("Location: ../assesmentDocumentSend?error=1&msg=" . urlencode($stmt->error));
        exit();
    }
    ...
    header("Location: ../assesmentDocumentSend");
    exit();
}
