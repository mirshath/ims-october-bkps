...
$query = "SELECT a.*, p.program_name, b.batch_name, m.module_name, 
          ac.as_main_component_name, sc.sub_component_name, a.subject_body
...
foreach ($students as $student) {
    ...
    try {
        ...
        $subjectPrefix = !empty($assessment['subject_body']) ? $assessment['subject_body'] : "";
        $mail->Subject = $subjectPrefix . " - " . $assessment['module_name'] . " - " . $assessment['as_main_component_name'];
