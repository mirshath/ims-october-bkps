        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="container p-3">
                    ...
                    <div class="row  g-3" id="card_enable" <?php echo !in_array('card_enable - index', $subListValues) ? 'style="pointer-events: none; color: gray;"' : ''; ?>>
                        <!-- Sales & Marketing -->
                        <div class="col-md-4">
                            <a href="uploadStudents">
                                <div class="section-card card_bg_orange">
                                    ...
                                    <!-- </div> -->
                                    <span class="card-title">Upload Student</span>
                                </div>
                            </a>
                        </div>
                        ...
                        <div class="col-md-4">
                            <a href="uploadScanCopies">
                                <div class="section-card card_bg_blue">
                                    <!-- <div class="section-icon"> -->
                                    <i class="fas fa-file-upload"></i>
                                    <!-- </div> -->
                                    <span class="card-title">Upload Student Documents</span>
                                </div>
                            </a>
                        </div>
