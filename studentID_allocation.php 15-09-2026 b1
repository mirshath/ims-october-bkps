            ...
            <div id="content">
                ...
                <div class="container p-3">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h4 class="h4 mb-0 text-gray-800">BMS STUDENT ID ALLOCATIONS MANUALLY</h4>
                    </div>
                    ...
                    <div class="mt-3 mb-3">
                        <div class="alert alert-warning d-flex align-items-center" role="alert">
                            ...
                            <div>
                                <strong>Important:</strong> Before uploading a CSV or Excel file, please first <b>fetch the student data</b>, export it to Excel, <b>fill in the required information</b>, and <b> then upload</b> that Excel file.
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="card shadow-sm">
                                <div class="card-header d-flex align-items-center" style="height: 60px;">
                                    ...
                                    <h6 class="mb-0 me-2">BMS Student ID Allocations Manually</h6>
                                </div>
                                <div class="card-body">
                            ...
                            <div class="form">
                                ...
                                <form id="uploadBmsExcelForm" enctype="multipart/form-data">
                                    <label for="bmsExcelFile" class="drop-container">
                                        <span class="drop-title">Drop Excel files here for Student ID allocation</span>
                                        or
        ...
        $('#uploadBmsExcelForm').submit(function(e) {
            ...
            reader.onload = function(e) {
                ...
                $.ajax({
                    ...
                    url: 'Batch_transer/upload_bms_excel_for_stdID.php',
                    type: 'POST',
                    data: {
        ...
        $(document).ready(function() {
                    ...
                    success: function(response) {
                        ...
                        response.students.forEach(function(student) {
                            table += `<tr>
                                ...
                                <td>${student.name}</td>
                              <td><input type="text" name="student_registration_id[${student.id}]" value="${student.student_registration_id || ''}" class="form-control"></td>
                        ...
                        table += `</tbody></table>
                            <div class="text-end mt-2">
                                <button type="submit" class="btn btn-success">UPDATE BMS STUDENT ID</button>
                            </div>
                        </form>`;
                        ...
                        $('#studentsTable').DataTable({
                            ...
                            buttons: [{
                                    extend: 'excelHtml5',
                                    title: `BMS Student IDs - ${programName} - ${batchName}`,
                                    exportOptions: {
                                        columns: ':visible',
                                        orthogonal: 'export'
                                    }
                            ...
                            columnDefs: [{
                                ...
                                {
                                    targets: [3, 4], // 3 = Registration ID, 4 = BMS Email
                                    render: function(data, type, row, meta) {
                                        // export current input value
                                        return type === 'export' ? $(data).val() : data;
                                    }
                                }
                            ],
            ...
            $(document).on('submit', '#updateBmsForm', function(e) {
                ...
                $.ajax({
                    ...
                    url: 'Batch_transer/update_bms_stdID.php',
                    type: 'POST',
                    data: $(this).serialize(),
                    success: function(response) {
                        alert(response);
