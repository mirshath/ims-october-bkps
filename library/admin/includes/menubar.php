<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="header"><BR>TRANSACTION</li>
      <li  style="font-size: 15px"><a href="borrow.php"><i class="fa fa-arrow-up"></i> Borrow</a></li>
          <li  style="font-size: 15px"><a href="return.php"><i class="fa fa-refresh"></i> Return</a></li>
