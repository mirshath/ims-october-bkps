        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                    <label for="nic_number" class="col-sm-3 control-label">NIC Number</label>
                    <div class="col-sm-9">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="student_edit.php">
                ...
                <div class="form-group">
                    <label for="edit_nic_number" class="col-sm-3 control-label">NIC Number</label>
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="edit_nic_number" name="nic_number">
                    </div>
                </div>
