...
$(function(){
  $(document).on('click', '#append', function(e){
    e.preventDefault();
    $('#append-div').append(
      '<div class="form-group"><label for="" class="col-sm-3 control-label">accession_number</label><div class="col-sm-9"><input type="text" class="form-control" name="accession_number[]"></div></div>'
    );
  });
});
</script>
