      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <a href="borrow.php"> 
            ...
            <div class="inner">
            <center><h3>BORROW<br><i class="fa fa-arrow-circle-right"></i><h3> </center>
            </div> 
            <div class="icon">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <a href="return.php">  
            ...
            <div class="inner">
            <center><h3>RETURN<br><i class="fa fa-arrow-circle-left"></i><h3> </center>
            </div>
            <div class="icon">
              <i class="fa fa-mail-reply"></i>
            </div>
            <!-- <a href="return.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i> -->
          </div>
        </div>
        </a>
...
$(function(){
  ...
  barChartData.datasets[1].fillColor   = '#e01e1e'
  barChartData.datasets[1].strokeColor = '#e01e1e'
  barChartData.datasets[1].pointColor  = '#e01e1e'
  var barChartOptions                  = {
