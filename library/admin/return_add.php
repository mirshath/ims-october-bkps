				...
				if(!empty($accession_number)){
					...
					if($query->num_rows > 0){
						...
						if($query->num_rows > 0){
							...
							$_SESSION['error'][] = 'Borrow details not found: Accession Number - '.$accession_number.', Student ID: '.$student;
						}
						...
						$_SESSION['error'][] = 'Book not found: accession_number - '.$accession_number;
					}
