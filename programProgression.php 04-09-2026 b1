...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $checkTransferStatusStmt->bind_param("i", $student_id);
    ...
    if ($transfer_status == 1) {
        ...
        $resetTransferStatusStmt->bind_param("i", $student_id);
        $resetTransferStatusStmt->execute();
        $resetTransferStatusStmt->close();
    }
    // ------------------------------------------------------------------------------------------------------ 
    // Check if the student is already active in the same program and batch
    $checkActiveQuery = "SELECT id FROM allocate_programme WHERE student_code = ? AND programme_code = ? AND batch_id = ? AND status = 'active'";
    if ($checkStmt = $conn->prepare($checkActiveQuery)) {
        $checkStmt->bind_param("iii", $student_id, $programme_code, $batch_id);
        $checkStmt->execute();
        $checkStmt->store_result();

        if ($checkStmt->num_rows > 0) {
            echo "<script>
                alert('Same Student, same program and same batch Already active');
    ...
    if ($allocateStmt = $conn->prepare($allocateQuery)) {
        ...
        if ($allocateStmt->execute()) {
            ...
            if ($stmt4) {
                ...
                if ($stmt4->execute()) {
                    ...
                    if ($program_status === 'same_program') {
                        ...
                        if ($adjusted_registration_fee < 0)
                            $adjusted_registration_fee = 0;
            ...
            // ======= STUDENT Progression ENTRY ======
            $query = "INSERT INTO program_progression_table 
            ...
            if ($stmt = $conn->prepare($query)) {
                ...
                // 1. student_id (i), 2. from_student (s), 3. from_university (s), 4. from_programme (s), 5. from_batch (s), 
                // 6. from_registration_code (s) [NEW CODE], 7. university_id (i), 8. programme_code (i), 9. batch_id (i), 
                // 10. allocated_id (i), 11. entered_by (s), 12. OLD_registration_id (s) [OLD CODE]
                $stmt->bind_param(
                    "isssssiiiiss",
                    $student_id,
                    $from_student,
                ...
                if ($stmt->execute()) {
                    ...
                    if ($nullRegStmt = $conn->prepare($nullRegQuery)) {
                        $nullRegStmt->bind_param("iii", $student_id, $program_old_code, $batch_old_code);
                        $nullRegStmt->execute();
                        $nullRegStmt->close();
                    }

                    echo "<script>
                        alert('Student Program Progression, Allocation & Payment Plan have been successfully recorded!');
                        window.location.href = window.location.href;
                    </script>";
                }
                $stmt->close();
        ...
        <div id="content">
            ...
            <div class="p-3">
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h4 class="h4 mb-0 text-gray-800">Program Progression</h4>
                </div>

                <!-- Filter Form -->
                <form action="programProgression.php" method="POST">
                    <div class="row mb-5">
                    ...
                    <div class="row">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" id="from_student" name="from_student"
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" id="from_university" name="from_university"
                                                    class="form-control" placeholder="From University" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" id="from_programme" name="from_programme"
                                                    class="form-control" placeholder="From Programme" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" id="from_batch" name="from_batch"
                                                    class="form-control" placeholder="From Batch" required>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-6">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <select id="programme" name="programme_code"
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <select required id="batch" name="batch_id" class="form-control select2"
                                                    required></select>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" readonly id="from_registration_code_old"
                                                    name="from_registration_code_old" class="form-control"
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <label for="from_registration_code"><s>Current Registration Last Code</s>
                                                </label>
                                            </div>
                                            <div class="col-md-8">
                                                <input type="text" readonly id="current_registration_last_code"
                                                    name="current_registration_last_code" class="form-control"
                                                    placeholder="New Registration Number"
                                                    style="border: 2px solid red;">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" readonly id="from_registration_code"
                                                    name="from_registration_code" class="form-control"
                                                    placeholder="New Registration Number"
                                                    style="border: 2px solid red;">
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        <label for="bms_registration_have_code" class="col-md-4 col-form-label">HAVE BMS
                                            Registration ID (AG)</label>
                                        <div class="col-md-8">
                                            <input type="text" id="bms_registration_have_code"
                                                name="bms_registration_have_code" class="form-control"
                                                placeholder="Auto Generated Registration Number" readonly
                                                style="border: 2px solid red;">
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label for="bms_registration_code_last" class="col-md-4 col-form-label">LAST BMS
                                            Registration ID (AG)</label>
                                        <div class="col-md-8">
                                            <input type="text" id="bms_registration_code_last"
                                                name="bms_registration_code_last" class="form-control"
                                                placeholder="Auto Generated Registration Number" readonly
                                                style="border: 2px solid red;">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="bms_registration_code" class="col-md-4 col-form-label">NEW BMS
                                            Registration ID (AG)</label>
                                        <div class="col-md-8">
                                            <input type="text" id="bms_registration_code" name="bms_registration_code"
                                                class="form-control" placeholder="Auto Generated Registration Number"
                                                readonly style="border: 2px solid red;">
                                        </div>
                                    </div>
                            ...
                            <div class="mt-4 text-right">
                                <button type="submit" class="btn btn-primary" id="transfer_sbt_btn">Submit Program
                                    Progression</button>
                            </div>
                        </div>
                    </div>
                ...
                if (batchId && programId) {
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            // $('#from_registration_code').val(nextRegId).prop('readonly', false);
                            $('#from_registration_code').val('').prop('readonly', true);
                            ...
                            // Populate LAST / NEW BMS Registration ID only when the student
                            // already HAS a BMS Registration ID. If HAVE is empty/null,
                            // both LAST and NEW must stay blank (no auto-suggestion).
                            const bmsHaveCode = $('#bms_registration_have_code').val();
                            ...
                            console.log("Last old registration:", lastOldRegId, " Next:", nextRegId);
                            console.log("Last new reg (ordered):", lastNewRegId, " HAVE code:", bmsHaveCode);
                        ...
                        success: function (response) {
                            ...
                            if (!response.error) {
                                ...
                                if (response.new_student_registration_id !== "" && response.new_student_registration_id !== null && typeof response.new_student_registration_id !== "undefined") {
                                    ...
                                    // No existing BMS Registration ID for this student ->
                                    // LAST and NEW BMS Registration ID must stay empty/null
                                    $('#bms_registration_code_last').val('').prop('readonly', true);
                                    $('#bms_registration_code').val('').prop('readonly', true);
                                }
