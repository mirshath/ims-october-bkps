                                                    ...
                                                    ?>
                                                        ...
                                                        if ($componentCount == 1) {
                                                            if (isset($componentGrades[0])) {
                                                                ...
                                                                $m = floatval($componentMarks[0] ?? 0);

                                                                if ($g === 'pending') {
                                                                    $finalHDGrade = getHDGradeFromMarksSingleComponent($m);
                                                                } elseif ($g === 're-sit') {
                                                                    $finalHDGrade = 'Re-sit';
                                                                } elseif (isAbsentHD($g)) {
                                                                    $finalHDGrade = 'Absent';
                                                                ...
                                                                } elseif (in_array($g, ['pass', 'merit', 'distinction'])) {
                                                                    $finalHDGrade = getHDGradeFromMarksSingleComponent($m);
                                                                } else {
                                                                    $finalHDGrade = $componentGrades[0];
                                                                }
                                                            } else {
                                                                echo "Error: No grades found for component 01";
                                                            }
...
function getHDGradeFromMarksSingleComponent($marks)
{
    if ($marks > 100) {
        return 'Unknown';
    }
    ...
    // ===== GRADE LOGIC (no Pending band — single component) =====
    if ($marks < 0) {
        return 'Not Submitted';
    } elseif ($marks == 0) {
        return 'Absent';
    } elseif ($marks >= 1 && $marks <= 48) {
        return 'Re-sit';
    } elseif ($marks >= 50 && $marks <= 59) {
        return 'Pass';
    } elseif ($marks >= 60 && $marks <= 69) {
