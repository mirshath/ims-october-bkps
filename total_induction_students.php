        ...
        <div id="content">
            ...
            <div class="container-fluid py-4">
                ...
                <div class="row mb-4">
                    <div class="col-12">
                        <h2 class="mb-2">
                            <i class="fas fa-users me-2"></i>All Induction Students Report
                        </h2>
                        <p class="text-muted mb-0">Complete list of all students in the induction_students table</p>
                    </div>
                </div>
                        ...
                        <div class="row ">
                            <div class="col-md-4 mb-3">
                                <label class="form-label fw-semibold text-secondary">
                                    <i class="fas fa-graduation-cap me-1"></i>Programme
                                </label>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select id="emailSentFilter" class="form-select form-select-sm">
                                    <option value="">All</option>
                ...
                <div class="card shadow-sm">
                    <div class="card-header bg-primary text-white">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h5 class="mb-0">
                                    <i class="fas fa-table me-2"></i>Induction Students Data
                                </h5>
                            </div>
                            <div>
    ...
    $(document).ready(function() {
        let table = $('#studentsTable').DataTable({
            ...
            columnDefs: [{
                ...
                {
                    targets: [3, 4, 14, 15], // Name, NIC, Email, BMS Email
                    orderable: true
                },
                {
                    targets: [7, 20, 21, 26], // Fees, Attended, Email Sent, Pack Collected
                    orderable: false
                }
            ],
            language: {
        ...
        $('#programmeFilter, #feesFilter, #attendedFilter, #emailSentFilter, #packCollectedFilter').on('change', function() {
            table.ajax.reload();
        });
